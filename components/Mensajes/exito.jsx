...
const Exito = ({onClose}) => {
  ...
  const handleReiniciar = () => {
    ...
    return (
      ...
      >
        <Fade in={open}>
          <Box className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4/12 rounded-md bg-black/20 m-2 py-2 px-2 text-base font-semibold text-black duration-300 ease-in-out hover:bg-black/30 dark:bg-white/20 dark:text-white dark:hover:bg-white/30">
            <Typography id="transition-modal-title" variant="h6" component="h2">
              <h2 className="mx-auto text-center">Mensaje enviado exitosamente!!</h2>
            </Typography>
